  ...
  return (
    <div className="flex h-screen w-64 flex-col bg-gray-800 text-white flex-shrink-0">
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        ...
        <NavLink to="/funds" className={({ isActive }) => isActive ? `${linkClasses} ${activeLinkClasses}` : linkClasses}>
          <Briefcase className="h-5 w-5 mr-3" />
          Funds
        </NavLink>
        <NavLink to="/goals" className={({ isActive }) => isActive ? `${linkClasses} ${activeLinkClasses}` : linkClasses}>
          <Target className="h-5 w-5 mr-3" />
          Goals
        </NavLink>
        <NavLink to="/recurring" className={({ isActive }) => isActive ? `${linkClasses} ${activeLinkClasses}` : linkClasses}>
